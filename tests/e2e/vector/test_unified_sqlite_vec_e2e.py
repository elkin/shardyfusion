"""End-to-end tests for the unified KV+vector reader (sqlite-vec) against Garage S3."""
...
def test_unified_sqlite_vec_e2e(
    garage_s3_service: dict[str, str], tmp_path: Path
) -> None:
    s3_prefix = f"s3://{garage_s3_service['bucket']}/e2e-unified-sqlite-vec"
